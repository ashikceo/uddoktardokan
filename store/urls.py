...
urlpatterns = [
    ...
    path('dashboard/products/toggle-publish/<int:pk>/', views.dashboard_product_toggle_publish, name='dashboard_product_toggle_publish'),
    ...
    path('dashboard/medicine-pos/orders/<int:pk>/invoice/', views.medicine_pos_invoice_pdf, name='medicine_pos_invoice_pdf'),
    path('dashboard/medicine-pos/report/', views.medicine_pos_daily_report, name='medicine_pos_daily_report'),
    path('dashboard/medicine-pos/settings/', views.medicine_pos_settings, name='medicine_pos_settings'),
